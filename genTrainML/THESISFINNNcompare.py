...
# Read files
directory = '/afs/hep.wisc.edu/home/incik/CMSSW_13_1_0_pre2/src/genTrainML/output/NN_orig.h5'
...
print("Total Prediction MSE: " + str(mean_squared_error(y_actual, y_fit)) + '\n')
print("Total Prediction RMSE: " + str(math.sqrt(mean_squared_error(y_actual, y_fit))) + '\n')
