...
canvas = ROOT.TCanvas('C', 'Canvas', 1000, 750)
...
hcalnpv.SetTitle("")
hcalnpv.GetXaxis().SetTitle("Number of Primary Vertices (npv)")
hcalnpv.GetYaxis().SetTitle("Number of (HCAL + ECAL) TPs")
...
canvas.Draw()
canvas.SaveAs('nHCALECALtpvnpv.png')
print("Hist 1 Done.")
...
totalhcaletnpv.SetTitle("")
totalhcaletnpv.GetXaxis().SetTitle("Number of Primary Vertices (npv)")
...
canvas.Draw()
canvas.SaveAs('totalhcaltpet.png')
print("Hist 2 Done.")
...
totalhecaletnpv.SetTitle("")
totalhecaletnpv.GetXaxis().SetTitle("Number of Primary Vertices (npv)")
totalhecaletnpv.GetYaxis().SetTitle("Total (HCAL E_{T} + ECAL E_{T})")
...
cmsLatex.DrawLatex(0.9, 0.92, "#font[61]{CMS} #font[52]{Preliminary}")
canvas.Draw()
canvas.SaveAs('totalhecaltpet.png')
print("Hist 3 Done.")
