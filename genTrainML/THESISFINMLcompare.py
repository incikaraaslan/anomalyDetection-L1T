...
directory2 = '/afs/hep.wisc.edu/home/incik/CMSSW_13_1_0_pre2/src/genTrainML/output/offsetggHbb_trial.h5'
...
lingraph.SetTitle("")
lingraph.GetXaxis().SetTitle("Total HCAL E_{T} + ECAL E_{T}") # Total HCAL E_{T} + ECAL E_{T}, Number of HCAL+ECAL TPs
