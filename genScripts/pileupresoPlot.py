...
canvas = ROOT.TCanvas()
hp = ROOT.TH1F("gencaloResPlot", "Resolution Plot", 100, -1.0, 1.0)
hpp = ROOT.TH1F("pgencaloResPlot", "Resolution Plot", 100, -1.0, 1.0)
hp010 = ROOT.TH1F("gencaloResPlot 0-10", "Resolution Plot 0-10", 100, -1.0, 1.0)
hp1020 = ROOT.TH1F("gencaloResPlot 10-20", "Resolution Plot 10-20", 100, -1.0, 1.0)
hp2030 = ROOT.TH1F("gencaloResPlot 20-30", "Resolution Plot 20-30", 100, -1.0, 1.0)
hp3040 = ROOT.TH1F("gencaloResPlot 30-40", "Resolution Plot 30-40", 100, -1.0, 1.0)
hp4050 = ROOT.TH1F("gencaloResPlot 40-50", "Resolution Plot 40-50", 100, -1.0, 1.0)
hp5060 = ROOT.TH1F("gencaloResPlot 50-60", "Resolution Plot 50-60", 100, -1.0, 1.0)
hp6070 = ROOT.TH1F("gencaloResPlot 60-70", "Resolution Plot 60-70", 100, -1.0, 1.0)
hp7080 = ROOT.TH1F("gencaloResPlot 70-80", "Resolution Plot 70-80", 100, -1.0, 1.0)
hpp010 = ROOT.TH1F("pgencaloResPlot 0-10", "Resolution Plot 0-10", 100, -1.0, 1.0)
hpp1020 = ROOT.TH1F("pgencaloResPlot 10-20", "Resolution Plot 10-20", 100, -1.0, 1.0)
hpp2030 = ROOT.TH1F("pgencaloResPlot 20-30", "Resolution Plot 20-30", 100, -1.0, 1.0)
hpp3040 = ROOT.TH1F("pgencaloResPlot 30-40", "Resolution Plot 30-40", 100, -1.0, 1.0)
hpp4050 = ROOT.TH1F("pgencaloResPlot 40-50", "Resolution Plot 40-50", 100, -1.0, 1.0)
hpp5060 = ROOT.TH1F("pgencaloResPlot 50-60", "Resolution Plot 50-60", 100, -1.0, 1.0)
hpp6070 = ROOT.TH1F("pgencaloResPlot 60-70", "Resolution Plot 60-70", 100, -1.0, 1.0)
hpp7080 = ROOT.TH1F("pgencaloResPlot 70-80", "Resolution Plot 70-80", 100, -1.0, 1.0)
