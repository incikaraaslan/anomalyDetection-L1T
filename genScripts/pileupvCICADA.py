...
hCS010 = ROOT.TH1F("Anomaly Score/Pileup Pred "+run+" 0-10", "Anomaly Score/Pileup Pred for 0-10", 100, 0.0, 3.0)
hCS1020 = ROOT.TH1F("Anomaly Score/Pileup Pred "+run+" 10-20", "Anomaly Score/Pileup Pred 10-20", 100, 0.0, 3.0)
hCS2030 = ROOT.TH1F("Anomaly Score/Pileup Pred "+run+" 20-30", "Anomaly Score/Pileup Pred 20-30", 100, 0.0, 3.0)
hCS3040 = ROOT.TH1F("Anomaly Score/Pileup Pred "+run+" 30-40", "Anomaly Score/Pileup Pred 30-40", 100, 0.0, 3.0)
hCS4050 = ROOT.TH1F("Anomaly Score/Pileup Pred "+run+" 40-50", "Anomaly Score/Pileup Pred 40-50", 100, 0.0, 3.0)
hCS5060 = ROOT.TH1F("Anomaly Score/Pileup Pred "+run+" 50-60", "Anomaly Score/Pileup Pred 50-60", 100, 0.0, 3.0)
