...
for i in range(3):
    if i == 0:
        ...
        hists[i].SetLineColor(ROOT.kBlue)
        hists[i].SetMarkerColor(ROOT.kBlue)
        hists[i].SetMarkerStyle(8)
        hists[i].SetMarkerSize(0.5)
        hists[i].SetTitle("")
        hists[i].GetXaxis().SetTitle("P_{T}")
        ...
        hists[i].SetTitle("")
        hists[i].GetYaxis().SetTitle("Events")
        hists[i].GetXaxis().SetTitle(f"$\phi$")
        hists[i].GetXaxis().SetTitleSize(0.045)
        hists[i].GetXaxis().SetTitleOffset(0.9)
        hists[i].GetYaxis().SetTitleSize(0.045)
        hists[i].GetYaxis().SetTitleOffset(0.9)
        ...
        hists[i].SetMarkerSize(0.5)
        hists[i].SetTitle("")
        hists[i].GetXaxis().SetTitle(f"$\eta$")
        hists[i].GetYaxis().SetTitle("Events")
        hists[i].GetYaxis().SetLabelSize(0.05)
        hists[i].GetXaxis().SetLabelSize(0.05)
        hists[i].GetXaxis().SetTitleSize(0.090)
        hists[i].GetXaxis().SetTitleOffset(0.25)
        hists[i].GetYaxis().SetTitleSize(0.090)
        hists[i].GetYaxis().SetTitleOffset(0.35)
...
cmsLatex.DrawLatex(0.93, 0.95, "#font[61]{CMS} #font[52]{Preliminary}")
canvas.Draw()
canvas.SaveAs('../genTrainML/controlPlots/PUPPIJet_ControlPlotmod.png')
print("PUPPI Done")
...
for i in range(3):
    if i == 0:
        ...
        hists2[i].SetTitle("")
        hists2[i].GetYaxis().SetTitle("Events")
        hists2[i].GetXaxis().SetTitle(f"$\phi$")
        hists2[i].GetXaxis().SetTitleSize(0.045)
        hists2[i].GetXaxis().SetTitleOffset(0.9)
        ...
        hists2[i].SetMarkerSize(0.5)
        hists2[i].SetTitle("")
        hists2[i].GetXaxis().SetTitle(f"$\eta$")
        hists2[i].GetYaxis().SetTitle("Events")
        hists2[i].GetYaxis().SetLabelSize(0.05)
        hists2[i].GetXaxis().SetLabelSize(0.05)
        hists2[i].GetXaxis().SetTitleSize(0.090)
        hists2[i].GetXaxis().SetTitleOffset(0.25)
        hists2[i].GetYaxis().SetTitleSize(0.090)
        hists2[i].GetYaxis().SetTitleOffset(0.35)
...
cmsLatex.DrawLatex(0.93, 0.95, "#font[61]{CMS} #font[52]{Preliminary}")
canvas2.Draw()
canvas2.SaveAs('../genTrainML/controlPlots/TRIGJet_ControlPlotmod.png')
print("Trig Done.")